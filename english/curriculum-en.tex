...
\cvevent{Senior Full-stack Engineer}{PrimeIT}{Feb 2022 -- Present}{Remote -- Lisbon, Portugal}
\begin{itemize}
...
\cvevent{Software and Data Engineer \& Scientific Researcher}{CERN -- European Organization for Nuclear Research}{Mar 2019 -- Mar 2020}{Geneva, Switzerland}
\begin{itemize}
	\item Designed and developed an energy estimation \textbf{algorithm} for the ATLAS Tile Calorimeter at the \textbf{Large Hadron Collider} -- the world's largest and most powerful particle accelerator.
	\item Designed and implemented a \textbf{machine learning}-based tool using \textbf{C++} and \textbf{Python}, integrated into CERN's complex world-wide \textbf{distributed system} using millions of events from real and simulated proton-proton collision data to train the models.
	\item Developed a high-performance pulse generator library in \textbf{C++} with \textbf{Python} interfaces, enabling the simulation of electronic readouts for physics analysis and AI model training, widely adopted by research groups globally.
\end{itemize}
