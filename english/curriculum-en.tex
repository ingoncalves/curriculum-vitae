...
\begin{itemize}
	\item Contributes to the design and evolution of large-scale, cloud-based software systems at \textbf{Siteimprove}, a global Software-as-a-Service (SaaS) platform for digital accessibility and content quality used by thousands of enterprise organizations worldwide.
	...
	\item Develops front-end applications and shared libraries using \textbf{JavaScript/TypeScript} and \textbf{React}, including the \textbf{Fancy Design System} component library, with emphasis on code quality, reusability, and accessibility compliance (\textbf{WAI-ARIA}).
	\item Contributes to the architecture and operation of cloud-native systems deployed on \textbf{AWS}, working with both \textbf{SQL} (Oracle) and \textbf{NoSQL} (DynamoDB) stores, together with CloudFront, ElastiCache, and Redis, with emphasis on scalability, performance, and reliability.
...
\begin{itemize}
	...
	\item Leads requirements gathering with stakeholders, release planning, deployment, monitoring, and end-user support.
\end{itemize}
...
\begin{itemize}
	\item Working as a software engineering consultant through Prime IT, currently assigned to \textbf{Siteimprove}. See the following entry for project details and responsibilities.
\end{itemize}
