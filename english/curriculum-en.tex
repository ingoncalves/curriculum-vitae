...
\cvevent{Senior Full-Stack Software Engineer}{Siteimprove}{Feb 2022 -- Present}{Remote -- Brazil}
\begin{itemize}
	\item Contributes to large-scale, cloud-based systems at \textbf{Siteimprove}, a global SaaS platform for digital accessibility and content quality used by enterprise organizations worldwide.
	\item Designs, implements, and maintains distributed back-end services in \textbf{Java (Spring Boot)}, \textbf{C\# (ASP.NET)}, and \textbf{Node.js (Express)}, exposing \textbf{RESTful APIs} consumed by multiple client applications.
	\item Develops front-end applications and shared libraries using \textbf{JavaScript/TypeScript} and \textbf{React}, including the \textbf{Fancy Design System} component library with accessibility compliance (\textbf{WAI-ARIA}).
	\item Contributes to cloud-native systems deployed on \textbf{AWS}, working with both \textbf{SQL} (Oracle) and \textbf{NoSQL} (DynamoDB) stores, together with CloudFront, ElastiCache, and Redis.
	\item Maintains services on \textbf{EKS} in \textbf{FedRAMP}-compliant environments and develops against cluster-hosted services using port-forwarding.
	\item Integrates \textbf{AI-based APIs} into product features, enabling data-driven insights and enhancing digital experiences for customers.
	\item Implements authentication and authorization mechanisms based on \textbf{OAuth 2.0}, \textbf{OpenID Connect}, and \textbf{SAML 2.0} for distributed services and web applications.
\end{itemize}

\divider%

\cvevent{Co-founder \& Founding Engineer}{Orkast}{Mar 2026 -- Present}{Remote -- Brazil}
\begin{itemize}
	\item Co-founded Orkast, a multi-tenant \textbf{SaaS B2B} platform (ERP + CRM + AI) for Portuguese SMEs, and acts as sole engineer owning the full product lifecycle from requirements to operations.
	\item Designed and implemented the back-end in \textbf{Node.js (NestJS)} and \textbf{TypeScript}, exposing \textbf{RESTful APIs} backed by \textbf{PostgreSQL} through an \textbf{ORM} layer (Prisma), with row-level multi-tenant isolation, \textbf{JWT}-based authentication, and role-/module-based authorization.
	\item Developed the front-end application in \textbf{React} and \textbf{TypeScript} (Vite, MUI, TanStack Query), including Kanban boards, financial dashboards, and reporting interfaces used by tenant organizations.
	\item Designed and operates the entire cloud infrastructure on \textbf{AWS} using \textbf{Terraform} (infrastructure as code), including \textbf{Aurora PostgreSQL Serverless}, \textbf{ECS Fargate}, ALB with HTTPS, ACM, ECR, and S3, with container-based deployments through \textbf{Docker}.
	\item Integrated generative-AI capabilities via the \textbf{Anthropic Claude API} for business diagnostics, CSV column inference in bank reconciliation, and natural-language reporting over tenant data.
\end{itemize}
...
\begin{itemize}
    \item Worked on-site from 2019 to 2020 designing and implementing advanced \textbf{energy reconstruction algorithms} in \textbf{C++} and \textbf{Python} for the ATLAS Tile Calorimeter, contributing to the \textbf{Athena} software framework (a large-scale open-source platform) and targeting high pile-up conditions at the \textbf{Large Hadron Collider}.
    ...
    %\item Designed and developed an open-source pulse generator and signal simulation library in \textbf{C++} with \textbf{Python} bindings, enabling realistic modeling of calorimeter electronics for physics studies and algorithm development; the tool has been adopted by multiple international research groups.
...
\cvevent{Software Engineering Consultant}{Prime IT}{Feb 2022 -- Present}{Remote -- Brazil}
\begin{itemize}
	\item Working as a software engineering consultant through Prime IT, currently assigned to \textbf{Siteimprove}.
\end{itemize}

\divider%

\cvevent{Technical Lead \& Senior Full-Stack Software Engineer}{O2 Filmes}{Sept 2018 -- Jan 2022}{Remote -- Brazil}
\begin{itemize}
...
\cvcontribution{Lorenzetti}{A general-purpose framework for signal reconstruction and triggering in high-energy calorimetry}{https://github.com/lorenzetti-ufrj-br/lorenzetti}

\cvcontribution{Calorimetry Pulse Simulator}{A pulse generator and signal simulation library for calorimeter electronics, with C++ core and Python bindings}{https://github.com/ingoncalves/calorimetry-pulse-simulator}
