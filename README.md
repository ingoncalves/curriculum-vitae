...
This document uses the AltaCV class. 
The basic template is found in ([view/open on Overleaf](https://www.overleaf.com/latex/templates/altacv-template/trgqjpwnmtgv)).
